...
public class C04_EntrySet {
    public static void main(String[] args) {
        ...
        System.out.println(ogrenciMap4.entrySet());

        Set<Map.Entry<Integer, String>> ogrenciEntrySet = ogrenciMap4.entrySet();   //Entry set olusturma

        for (Map.Entry<Integer, String> eachEntry : ogrenciEntrySet
        ) {
            System.out.println(eachEntry);  //her bir each
        ...
        System.out.println("sinif degisikligi " +ogrenciMap4);
